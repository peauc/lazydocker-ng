...
func spanishSet() TranslationSet {
	return TranslationSet{
		...
		StartingProjectStatus:       "iniciando proyecto",
		StoppingProjectStatus:       "deteniendo proyecto",
		ConfirmStopProject:          "¿Realmente quieres detener tu proyecto docker compose?",
