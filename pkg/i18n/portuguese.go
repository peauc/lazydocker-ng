...
func portugueseSet() TranslationSet {
	return TranslationSet{
		...
		StartingProjectStatus:       "iniciando projeto",
		StoppingProjectStatus:       "parando projeto",
		ConfirmStopProject:          "Tem certeza que deseja parar seu projeto docker compose?",
